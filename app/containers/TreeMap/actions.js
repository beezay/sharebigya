...
// Load TreeMap Data
export function loadTreeMapData(treeMapData) {
  return {
    type: LOAD_TREEMAP_DATA,
    treeMapData,
  };
}

export function loadTreeMapDataSuccess(treeMapData) {
  return {
    type: LOAD_TREEMAP_DATA_SUCCESS,
    treeMapData,
  };
}
export function loadTreeMapDataError(error) {
  return {
    type: LOAD_TREEMAP_DATA_ERROR,
    error,
  };
}
